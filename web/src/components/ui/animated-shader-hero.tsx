...
// Custom interface for Program with uniform locations
...
class PointerHandler {
  ...
  private map(element: HTMLCanvasElement, scale: number, x: number, y: number) {
  ...
  constructor(element: HTMLCanvasElement, scale: number) {
    ...
    element.addEventListener('pointerdown', (e) => {
      this.active = true;
      this.pointers.set(e.pointerId, this.map(element, this.getScale(), e.clientX, e.clientY));
    });
...
const useShaderBackground = () => {
  ...
  }, []); // Dependencies are stable (functions/classes defined outside, refs are stable)
